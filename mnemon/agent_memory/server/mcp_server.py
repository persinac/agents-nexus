...
async def create_note(
    ...
    links: explicit entity names to link this note to (file paths, module names, repo names).
           ...
           "everything that mentions example-service".
...
async def query_entity(
    ...
    Use to answer questions like:
      ...
      "Which notes mention example-service?"
...
async def recent_events(
    ...
    Useful for understanding recent agent activity:
      recent_events("example-service", hours=48)
      recent_events("example-service", event_type="session_start")
